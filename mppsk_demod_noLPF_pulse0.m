...
K=48  %=2  % 57 %48   % 20  %2  %99  %198  %24    %6     %3; %2;    % every diverse is 2T
...
snr=[100 -6 -3 0 3 6 9 12 15 18 21];
...
Nblocks =[20 80 80 80 80 160 160 160 160 160 160 160 160 160];
[m n]=size(snr);
pe=[];
mppskfilter=[];
...
%% ***********learn the signals' input and output under this SNR**************     
 % train_t=1:n1;
    ...
    %********map to one**************
    [y_mppsk_baoluo_tmp,y_mppsk_baoluo_tmps]=mapminmax(y_mppsk_baoluo_tmp);
