...
K =200  %=57 % 48  %6  %8  %8  %133  %198  %6     %3; %2;    % every diverse is 2T
...
%**************pass the SIF*************        
 ...
 %% *****************plot the fiure*************************** 
  ...
  % plot(10*log10(pwn),'r');
    ...
    alpha=1.2;
    pulsenoise1 = stblrnd(alpha,0,delta,0,[1,symbol_sample_stream_num]);
     y_mppsk1=mppsk+pulsenoise1; 
     alpha=1.8;
  pulsenoise2 = stblrnd(alpha,0,delta,0,[1,symbol_sample_stream_num]);
     y_mppsk2=mppsk+pulsenoise2;     
