...
Nblocks =[100 200 400 600 800 800 800];
...
%% initialize the variables---------------------------------------------------------------------
   ...
   % alpha=1.5;
   % pulsenoise = stblrnd(alpha,0,delta,5,[1,symbol_sample_stream_num]);
...
%% ***********learn the signals' input and output under this SNR**************     
 % train_t=1:n1;
     if j==1
      ...
      net.trainParam.lr= 0.00001;   %0.000005;  %  %0.001;0.001;  % learning ratio
